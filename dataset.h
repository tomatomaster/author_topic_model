...
public:
    ...
    document(int length, int author_num){
      this->length = length;
      this->author_num = author_num;
      rawstr = "";
      words = new int[length];
      authors = new int[author_num];
    }
...
public:
    ...
    static int show_model_id(string filename, document * pdoc);
    static int write_wordmap(string wordmapfile, mapword2id * pword2id);
    static int write_authormap(string wordmapfile, mapauthor2id * pword2id);
    ...
    static int read_authormap(string wordmapfile, mapid2author * pid2word);
    
    int read_trndata(string dfile, string wordmapfile, string authormapfile);
